...
The UI direction was informed by:
...
- Added a visible **Agent Workflow** strip so users see the sequence: intake, parse, match, audit, chat, report.
- Added **AI-assisted** and **Source-locked** badges to clarify the AI boundary.
- Added persistent memory cards for thread, source, graph, and audit memory.
- Improved evidence cards, support states, table rhythm, and report framing.
- Made the header/action area more stable and professional for repeated use.
- Improved mobile responsiveness for the dense workspace.
